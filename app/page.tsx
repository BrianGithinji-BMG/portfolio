      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            {
              id: '02',
              title: 'ZokoData — NSE Data Access & Distribution Platform',
              desc: 'Full-stack data infrastructure that scrapes NSE bulletin PDFs, extracts and aggregates equities data into clean datasets, and sells them via M-Pesa STK Push checkout.',
              tags: ['Fintech', 'Data Platform', 'Payments'],
              tech: 'FastAPI · PostgreSQL · React · M-Pesa Daraja',
            },
            {
              id: '03',
            ...
            },
            {
              ...
              desc: 'Interactive web app forecasting Kenya\u2019s Central Bank repo rate from the BFE 4.2 dissertation \u2014 three switchable models, confidence bands, and editable lag history for stress-testing.',
              tags: ['Time Series', 'Econometrics', 'Quant'],
              tech: 'Next.js · Python · XGBoost · Recharts',
            },
            {
              id: '05',
